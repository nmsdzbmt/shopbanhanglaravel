					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 383 185 763</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> nmsdzbmt@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
							...
							<li><a href="{{URL:: to('/trangchu')}}" class="active">Trang chủ</a></li>
								<li class="dropdown"><a href="#">Sản phẩm<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										<li><a href="product-details.html">Thông tin sản phẩm</a></li> 
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>LARAVEL</span>-SHOPPER</h1>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{URL::to('/danh-muc-san-pham/'.$cate_pro->category_id)}}">{{$cate_pro->category_name}}</a></h4>
								</div>
							</div>
							@endforeach
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="{{URL::to('/thuong-hieu-san-pham/'.$band_pro->brand_id)}}"> <span class="pull-right"></span>{{$band_pro->brand_name}}</a></li>
									@endforeach
								</ul>
							</div>
						</div><!--/brands_products-->
