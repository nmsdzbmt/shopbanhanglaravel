        ...
        <div class="product-details">
            ...
            <div class="col-sm-7">
                <div class="product-information">
                    ...
                    <a href=""><img src="{{ URL::to('/public/fontend/images/share.png') }}" class="share img-responsive"
                            alt="" /></a>
                </div>
                <!--/product-information-->
            </div>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="{{ URL::to('public/upload/product/' . $related->product_image) }}" height="250"
                                            alt="" />
